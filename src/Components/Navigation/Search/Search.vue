<template>
  <li class="navigation-icons-item">
    <transition name="fade">
      <div v-show="isSearchBarToggled" class="searchbar-container">
        <input class="searchbar-text" type="text"/>
    ...
    <button v-bind:class="{active : isSearchBarToggled}" v-on:click="toggleSearchBar" class="navigation-icon">
